...
import { Crown, AlertCircle, Loader2, Plus, Trash2 } from 'lucide-react';
import {
  apiCreatePlan,
  apiUpdatePlan,
  errorMessage,
...
export const PlanFormModal: React.FC<PlanFormModalProps> = ({
  ...
  const inputCls =
    'input-field bg-slate-100 dark:bg-slate-800';
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                type="button"
                onClick={addFeature}
                className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-500/20 dark:bg-emerald-500/100 text-white text-[10px] font-bold transition-colors"
              >
              ...
              {features.map((f, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-500/30 transition-colors"
