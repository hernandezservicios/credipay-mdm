...
export const PlatformAdminView: React.FC<PlatformAdminViewProps> = ({
  ...
  return (
    <div className="space-y-6">
          ...
          {tenants.map((t) => (
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                ...
                {t.tenant_status === 'SUSPENDED' ? (
                  <button
                    ...
                    className="flex items-center justify-center space-x-1 px-2 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-bold transition-colors disabled:opacity-60"
                  >
                    {busyId === t.tenant_id ? (
              ...
              <button
                ...
                disabled={!canEnter(t)}
                className="mt-2 flex items-center justify-center space-x-1.5 w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      {changePlanFor && (
        <ModalShell title={`Cambiar plan — ${changePlanFor.name}`} onClose={() => setChangePlanFor(null)}>
          <select
            value={newPlanId}
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-colors disabled:opacity-50 flex items-center space-x-2"
            >
      ...
      {suspendFor && (
        <ModalShell title={`Suspender — ${suspendFor.name}`} onClose={() => setSuspendFor(null)}>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 resize-none"
          />
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button
              ...
              disabled={working}
              className="px-4 py-2 rounded-lg bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition-colors disabled:opacity-50 flex items-center space-x-2"
            >
              {working && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
      ...
      {extendFor && (
        <ModalShell title={`Extender período — ${extendFor.name}`} onClose={() => setExtendFor(null)}>
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-28 px-3 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
